...
1. Download the application [mhk2_manager.jar](https://github.com/Markimk13/mhk2_manager/raw/master/source/mhk2_manager.jar).
...
By pressing *CRTL-S* or going in `File -> Einstellungen (Settings)`. You can set
